...
public interface SysRoleMapper {
     ...
     *
     * @mbggenerated Sat Apr 28 15:24:37 CST 2018
     */
    ...
    @Insert({
        ...
        "#{domainId,jdbcType=VARCHAR}, #{enname,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, office_id, domain_id, enname, name, role_type, data_scope, is_sys, useable, ",
