...
public interface SysDomainMapper {
     ...
     */
    @Insert({
        "insert into sys_domain (id, code, ",
        "name, home_page, ",
        "useable, create_by, ",
        ...
        "#{name,jdbcType=VARCHAR}, #{homePage,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, code, name, home_page, useable, create_by, create_date, update_by, update_date, ",
        "remarks, del_flag",
        "from sys_domain",
        "where id = #{id,jdbcType=VARCHAR}"
    })
