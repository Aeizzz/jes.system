...
public interface SysAreaMapper {
    ...
    @Insert({
        ...
        "#{parentIds,jdbcType=VARCHAR}, #{code,jdbcType=VARCHAR}, ",
        "#{name,jdbcType=VARCHAR}, #{sort,jdbcType=DECIMAL}, #{type,jdbcType=CHAR}, ",
    ...
    @Select({
        "select",
        "id, parent_id, parent_ids, code, name, sort, type, create_by, create_date, update_by, ",
