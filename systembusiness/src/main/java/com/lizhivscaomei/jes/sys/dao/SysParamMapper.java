...
public interface SysParamMapper {
     ...
     */
    @Insert({
        "insert into sys_param (id, domain_id, ",
        "name, code, value, ",
        "description, create_by, ",
        "create_date, update_by, ",
        "update_date, remarks)",
        "values (#{id,jdbcType=VARCHAR}, #{domainId,jdbcType=VARCHAR}, ",
        "#{name,jdbcType=VARCHAR}, #{code,jdbcType=VARCHAR}, #{value,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, domain_id, name, code, value, description, create_by, create_date, update_by, ",
        "update_date, remarks",
        "from sys_param",
        "where id = #{id,jdbcType=VARCHAR}"
    })
